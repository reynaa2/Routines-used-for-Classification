...
def matches(x,y,z,switch,w,s,t,v):
    # s = snr
    # t = HJD
    # v = visit
    # w = peak values
    ...
    # Use indexes to find relating apogee,location ids, visit, SNR, and HJD
    match_apogeeid = y[indexes]
    match_locationid = z[indexes]
    match_visit = v[indexes]
    match_snr = s[indexes]
    match_hjd = t[indexes]
    ...
    return match_param_array,match_apogeeid,match_locationid, match_peakvalue,match_visit,match_snr, match_hjd
...
# filepath2 = 'DR14_Stats_Catalog_JMR_Revision.csv'
...
# dr14 = matches(R51,apogeeid,locationid,0,peak_value,snr,hjd,visits)
# dr14_peakvalues = dr14[3]
# dr14_locationid = dr14[2]
# dr14_apogeeid = dr14[1]
# dr14_R51 = dr14[0]
# print('FINDING MIN R 101')
# r101 = matches(R101,apogeeid,locationid,0,peak_value,snr,hjd,visits)
# dr14_R101= r101[0]
# print('FINDING MIN R 151')
# r151 = matches(R151,apogeeid,locationid,0,peak_value,snr,hjd,visits)
# dr14_R151 = r151[0]
# print('FINDING MIN R151/R101')
# ratio_1 = matches(ratio1,apogeeid,locationid,0,peak_value,snr,hjd,visits)
# dr14_R1 = ratio_1[0]
# print('FINDING MIN R101/R51')
# ratio_2 = matches(ratio2,apogeeid,locationid,0,peak_value,snr,hjd,visits)
# dr14_R2 = ratio_2[0]
# print('FINDING MAX X RANGE')
# xr = matches(xranges,apogeeid,locationid,1,peak_value,snr,hjd,visits)
# dr14_xr = xr[0]
...
# df.to_csv('DR14_SmallR_LargeXR_Revised.csv')
# # df.to_csv('DR14_SmallR_LargeXR_JMR_Revised.csv')

# -------- CODE FOR MAKING ACTUAL PLOTS ----- ###

# Read in the DR14 catalog of minimum R, min R ratios, and max x-range values
filename = 'DR14_SmallR_LargeXR_Revised.csv'
...
dr14_ratio1 = np.asarray(data['log(R151/R101)'])
dr14_ratio2 = np.asarray(data['log(R101/R51)'])
dr14_peak_value = np.asarray(data['log(Peak_value)'])
dr14_xranges = np.asarray(data['log(xr)'])
...
tsb_ratio1 = np.asarray(tsb_data['log(R151/R101)'])
tsb_ratio2 = np.asarray(tsb_data['log(R101/R51)'])
tsb_xr = np.asarray(tsb_data['log(xr)'])
tsb_peakvalue = np.asarray(tsb_data['log(Peak_value)'])

#Impliment if statement to eliminate targets with log(xranges) > 2.5 due to this being our flag for bad data
dr14_locationid = dr14_locationid[dr14_xranges < 2.5]
dr14_apogeeid = dr14_apogeeid[dr14_xranges < 2.5]
dr14_r51 = dr14_r51[dr14_xranges < 2.5]
dr14_r101 = dr14_r101[dr14_xranges < 2.5]
dr14_r151 = dr14_r151[dr14_xranges < 2.5]
dr14_ratio1 = dr14_ratio1[dr14_xranges < 2.5]
dr14_ratio2 = dr14_ratio2[dr14_xranges < 2.5]
dr14_peak_value = dr14_peak_value[dr14_xranges < 2.5]
dr14_xr = dr14_xranges[dr14_xranges < 2.5]


# ##---- GO BACK TO USING THE TWOD_HIST FUNCTION -----##

#Generate a graph for xrange vs R_101
xr_vs_r101 = twod_hist(dr14_xr,dr14_r101,tsb_xr,tsb_r101,'X ranges vs R_101 2','log(max x-range)','log($R_{101}$)',-0.4,2,-0.1,2)

#Generate a graph for max x-range vs R_101/R_51 (Ratio 2)
xr_vs_R2 = twod_hist(dr14_xr,dr14_ratio2,tsb_xr,tsb_ratio2,'X ranges vs R101_R51','log(max x-range)','log($R_{101}/R_{51}$)',-0.5,0.2,-0.1,2)

#Generate a graph for max x-range vs R_151/R_101 (Ratio 1)
xr_vs_R1 = twod_hist(dr14_xr,dr14_ratio1,tsb_xr,tsb_ratio1,'X ranges vs R151_R101','log(max x-range)','log($R_{151}/R_{101}$)',-0.4,0.1,-0.1,2)

#Generate a graph for R_51 vs R_101/R_51 (Ratio 2)
r51_vs_R2 = twod_hist(dr14_r51,dr14_ratio2,tsb_r51,tsb_ratio2,'R51 vs R101_R51','log($R_{51}$)','log($R_{101}/R_{51}$)',-0.8,0.12,0.1,1.50)

#Generate a graph for R_101 vs R_151/R_101 (Ratio 1)
r101_vs_R1 = twod_hist(dr14_r101,dr14_ratio1,tsb_r101,tsb_ratio1,'R101 vs R151_R101','log($R_{101}$)', 'log($R_{151}/R_{101}$)',-0.5,0.1,0.1,2)
...
# #Generate a graph for R_51 vs R_101/R_51 (Ratio 2)
# r51_vs_R2 = twod_hist(dr14_r51,dr14_ratio2,tsb_r51,tsb_ratio2,'R51 vs R101_R51','log($R_{51}$)','log($R_{101}/R_{51}$)',-1.5,0.1,0,2)#,0.5,0.5,0.9,0.5)

# #Generate a graph for R_101 vs R_151/R_101 (Ratio 1)
# r101_vs_R1 = twod_hist(dr14_r101,dr14_ratio1,tsb_r101,tsb_ratio1,'R101 vs R151_R101','log($R_{101}$)', 'log($R_{151}/R_{101}$)',-1.5,0.1,0,2)#,0.5,0.5,0.9,0.5)